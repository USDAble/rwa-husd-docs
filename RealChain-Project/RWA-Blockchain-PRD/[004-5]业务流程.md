...
| 阶段 | 活动 | 预计时间 | 说明 |
|------|------|---------|------|
| **阶段1** | 锁定资产 | 2-6秒 | 源链交易确认 |
| **阶段2** | 跨链中继 | 1-3分钟 | 中继器处理 |
| **阶段3** | 释放资产 | 2-6秒 | 目标链交易确认 |
| **总计** | - | 2-5分钟 | - |
...
**投资池结构**:
- Senior Tranche (优先级): 目标APY 8%
- Junior Tranche (次级): 目标APY 15%
